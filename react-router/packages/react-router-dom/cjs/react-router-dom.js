...
var Link = forwardRef(function (_ref2, forwardedRef) {
  ...
  return React.createElement(reactRouter.__RouterContext.Consumer, null, function (context) {
    ...
    var history = context.history; // 获取从context.location 到 to指定location的路径

    var location = normalizeToLocation(resolveToLocation(to, context.location), context.location); // 根据location创建a标签使用的href属性
