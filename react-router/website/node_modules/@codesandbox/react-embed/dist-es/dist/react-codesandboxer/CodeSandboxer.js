...
var CodeSandboxDeployer = (function (_Component) {
    ...
    function CodeSandboxDeployer() {
        ...
        return ((_ret = ((_temp = ((_this = (0, _possibleConstructorReturn3["default"])(this, (_ref =
            CodeSandboxDeployer.__proto__ ||
                (0, _getPrototypeOf2["default"])(CodeSandboxDeployer)).call.apply(_ref, [this].concat(args)))),
            _this)),
            (_this.state = {
                parameters: '',
                isLoading: false,
            ...
            (_this.loadFiles = function () {
                var _this$props = _this.props, onLoadComplete = _this$props.onLoadComplete, providedFiles = _this$props.providedFiles, dependencies = _this$props.dependencies, name = _this$props.name;
            ...
            (_this.deploy = function () {
                var _this$props2 = _this.props, afterDeploy = _this$props2.afterDeploy, skipRedirect = _this$props2.skipRedirect, afterDeployError = _this$props2.afterDeployError;
                var _this$state = _this.state, parameters = _this$state.parameters, error = _this$state.error;
                if (error)
                    return;
                (0, _codesandboxer.sendFilesToCSB)(parameters)
                    .then(function (_ref2) {
                    var sandboxId = _ref2.sandboxId, sandboxUrl = _ref2.sandboxUrl;
                    _this.setState({
                        sandboxId: sandboxId,
            ...
            (_this.deployToCSB = function (e) {
                var _this$state2 = _this.state, deployPromise = _this$state2.deployPromise, isDeploying = _this$state2.isDeploying;
                if (e) {
                    e.preventDefault();
                }
                if (isDeploying)
    ...
    (0, _createClass3["default"])(CodeSandboxDeployer, [
        ...
        },
        {
            ...
            value: function render() {
                var _state = this.state, isLoading = _state.isLoading, isDeploying = _state.isDeploying, error = _state.error, sandboxId = _state.sandboxId, sandboxUrl = _state.sandboxUrl;
                return _react2["default"].createElement(_reactNodeResolver2["default"], { innerRef: this.getButton }, this.props.children({
                    isLoading: isLoading,
...
CodeSandboxDeployer.defaultProps = {
    children: function children() {
        return _react2["default"].createElement('button', { type: 'submit' }, 'Deploy to CodeSandbox');
    },
    pkgJSON: {},
    dependencies: {},
    providedFiles: {},
