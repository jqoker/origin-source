...
var SandboxEmbed = (function (_super) {
    ...
    SandboxEmbed.prototype.render = function () {
        ...
        if (this.state.error) {
            return this.props.renderError ? (this.props.renderError(this.state.error)) : (React.createElement("div", { style: this.props.style }, "Something went wrong while fetching the sandbox:", ' ', this.state.error.message));
        }
        var usedSandboxId = this.state.sandboxId || this.state.oldSandboxId;
        return (React.createElement(React.Fragment, null, usedSandboxId && (React.createElement("iframe", { name: "codesandbox", style: style, src: this.generateEmbedURL(usedSandboxId) })), !this.state.sandboxId && (React.createElement(CodeSandboxer_1["default"], __assign({}, this.props.sandboxOptions, { autoDeploy: true, skipRedirect: true, afterDeploy: this.afterDeploy, onLoadComplete: this.onLoadComplete }), function () {
